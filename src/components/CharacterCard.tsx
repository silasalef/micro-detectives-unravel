    ...
    >
      ...
      {isHovered && (
        <>
          ...
          <div className="absolute top-4 right-8 w-1 h-1 bg-blue-400 rounded-full animate-ping" style={{animationDelay: '0.3s'}}></div>
          <div className="absolute top-6 right-4 w-1 h-1 bg-purple-400 rounded-full animate-ping" style={{animationDelay: '0.6s'}}></div>
        </>
      )}

      <CardContent className="p-6 relative z-10">
        <div 
          className={`w-full h-32 bg-gradient-to-br ${color} rounded-2xl mb-4 flex items-center justify-center text-white text-4xl group-hover:animate-pulse relative overflow-hidden shadow-lg`}
